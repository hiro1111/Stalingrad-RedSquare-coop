...
# 現配布場所
[github] (https://github.com/hiro1111/Stalingrad_RedSquare_coop/releases)

# 概略
Stalingrad_RedSquare(赤の広場)をCOOP化・微調整したMAPです
FHSWフォーラムが閉鎖したため代替的にGithubで公開しています
なお、本readmeファイルはMAPファイル内にも埋め込んであります

【【注意】】装甲列車にBOTが湧くとクラッシュするので枢軸にBOTは割り振らないでください
